    ...
    public class TrailersController : Controller
    {
        ...
        public void SelectLoadingType()
        {
            List<SelectListItem> items = new List<SelectListItem>();
                ...
                items.Add(new SelectListItem { Text = "Bottom", Value = false.ToString() });
       ...
       // [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "TrailerID,TrailerCode,LoadingType,VehicleID")] Trailer trailer)
        {

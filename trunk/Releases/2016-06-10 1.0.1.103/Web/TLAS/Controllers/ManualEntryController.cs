...
namespace TLAS.Controllers
{
    ...
    public class ManualEntryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,AccessCardID,ModifiedDate,DeletedFlag,CreatedDate,ShipmentStatusID,OrderID,BayID,BayName,CustomerName,VehicleCode,DriverName,DriverCNIC,CarrierName,ShipmentDate,ProductID")] Shipment shipment, FormCollection formCollection)
        {
